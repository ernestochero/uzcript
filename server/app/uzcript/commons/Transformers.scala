...
object Transformers {
  ...
  implicit final class FutureJavaConverter[V](
    val self: java.util.concurrent.Future[V]
  ) {
    def toTask: Task[V] =
  ...
  implicit final class OptionalJavaConverter[V](
    val self: java.util.Optional[V]
  ) {
